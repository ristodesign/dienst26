...
@section('pageHeading')
    {{ !empty($pageHeading) ? $pageHeading->signup_page_title : __('Singup') }}
@endsection
...
@section('content')
    @includeIf('frontend.partials.breadcrumb', [
        ...
        'title' => !empty($pageHeading) ? $pageHeading->signup_page_title : __('Singup'),
    ])
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-20">
                                            ...
                                            <input type="text" name="username" value="{{ old('username') }}"
                                                id="userName" class="form-control" placeholder="{{ __('Username') }}">
                                            @error('username')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-20">
                                            <label for="confirmPassword"
                                                class="form-label color-dark">{{ __('Confirm Password') }}
