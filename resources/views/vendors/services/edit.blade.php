                              ...
                              <div class="row">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old($language->code . '_name', @$serviceContent->name) }}"
                                ...
                                <div class="col-lg-6">
                                  @php
                                    ...
                                    $oldCategoryId = old($language->code . '_category_id', @$serviceContent->category_id);
                                    $oldSubcategoryId = old($language->code . '_subcategory_id', @$serviceContent->subcategory_id);
                                  ...
                                  <div class="form-group position-relative service-cat-search-group">
                                    ...
                                    <div class="list-group service-cat-search-results d-none"
                                      data-lang_code="{{ $language->code }}" role="listbox"
                                      aria-label="{{ __('Search results') }}"></div>
