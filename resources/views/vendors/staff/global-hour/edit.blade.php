    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form autocomplete="off" id="ajaxEditForm" class="modal-form"
          action="{{ route('vendor.global.time-slot.update') }}" method="post">
          @csrf
          <input type="hidden" id="in_id" name="id">
          <input type="hidden" name="global_day_id" value="{{ request()->day_id }}">
          ...
          <div class="form-group">
            ...
            <p class="text-warning mt-2 mb-0">
              <small>
                {{ __('Maximum number of bookings staff/vendor can take during this time slot.') }}
                <br>
