      ...
      <div class="card">
        ...
        <div class="col-lg-10 mx-auto">
          <div class="card-body pt-5 pb-5">
            ...
            <div class="row">
              <div class="col-lg-12">
                <form id="serviceForm" action="{{ route('admin.staff_managment.update', ['id' => $staff->id]) }}"
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                              ...
                              <option value="1" @if ($staff->status == 1) selected @endif>
                                {{ __('Active') }}
                              </option>
                              <option value="0" @if ($staff->status == 0) selected @endif>
                                {{ __('Deactive') }}
                              </option>
                            </select>
                          </div>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="order_number"
                              value="{{ $staff->order_number }}" placeholder="Enter Order Number">
                            ...
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="login_allow_toggle" value="1"
                                  class="selectgroup-input" {{ $staff->allow_login == 1 ? 'checked' : '' }}>
                                <span class="selectgroup-button">{{ __('YES') }}</span>
                              </label>

                              <label class="selectgroup-item">
                                <input type="radio" name="login_allow_toggle" value="0"
                                  class="selectgroup-input" {{ $staff->allow_login == 0 ? 'checked' : '' }}>
...
@section('script')
  @if ($websiteInfo->google_map_status == 1)
    <script>
      "use strict";
      var address = "{{ @$staff_address->location }}";
