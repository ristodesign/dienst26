      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="{{ route('admin.home_page.store_banner') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="url" placeholder="{{ __('Enter Banner URL') }}">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="serial_number"
              placeholder="{{ __('Enter Banner Serial Number') }}">
            <p id="err_serial_number" class="mt-2 mb-0 text-danger em"></p>
            <p class="text-warning">{{ __('The higher the serial number is, the later the banner will be shown.') }}
            </p>
          </div>
        </form>
      </div>
