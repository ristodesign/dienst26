...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Edit Admin Keyword') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('Edit Admin Keyword') }}</a>
      </li>
    </ul>
  </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <form id="languageKeywordForm"
                action="{{ route('admin.language_management.update_admin_keyword', ['id' => $language->id]) }}" method="post">
                @csrf
                <div class="row">
