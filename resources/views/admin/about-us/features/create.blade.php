  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Features') }}</h5>
      ...
      <div class="modal-body">
        <form id="featureForm" class="modal-form create"
          action="{{ route('admin.about_us.store_features', ['language' => request()->input('language')]) }}"
          method="post">
          @csrf
          ...
          <div class="form-group">
            <label for="">{{ __('Features Icon') . '*' }}</label>
          ...
          <div class="form-group">
            ...
            <textarea name="text" class="form-control" placeholder="{{ __('Enter Text') }}"></textarea>
      ...
      <div class="modal-footer">
        ...
        <button id="featureBtn" type="button" class="btn btn-primary btn-sm">
          {{ __('Save') }}
        </button>
      </div>
    </div>
