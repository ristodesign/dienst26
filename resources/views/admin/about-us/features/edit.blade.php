  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Features') }}</h5>
      ...
      <div class="modal-body">
        <form id="featueUpdateForm" class="modal-form" action="{{ route('admin.about_us.update_features') }}"
          method="post">
          @csrf
      ...
      <div class="modal-footer">
        ...
        <button id="featureUpdate" type="button" class="btn btn-primary btn-sm">
          {{ __('Update') }}
        </button>
      </div>
    </div>
