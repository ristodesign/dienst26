    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('admin.announcement_popups.select_popup_type') }}">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="ajaxForm" class="create" action="{{ route('admin.announcement_popups.store_popup') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      <label>{{ __('Name') . '*' }}</label>
                      <input type="text" class="form-control" name="name" placeholder="{{ __('Enter Popup Name') }}">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control ltr" name="button_url" placeholder="{{ __('Enter Button URL') }}">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker ltr" name="end_date" placeholder="{{ __('Enter End Date') }}" readonly autocomplete="off">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control timepicker ltr" name="end_time" placeholder="{{ __('Enter End Time') }}" readonly autocomplete="off">
