      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block"
            href="{{ route('admin.announcement_popups', ['language' => $currentLang->code]) }}">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title"
                          placeholder="{{ __('Enter Popup Title') }}" value="{{ $popup->title }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="button_text"
                          placeholder="{{ __('Enter Button Text') }}" value="{{ $popup->button_text }}">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control ltr" name="button_url"
                          placeholder="{{ __('Enter Button URL') }}" value="{{ $popup->button_url }}">
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control ltr" name="serial_number"
                        placeholder="{{ __('Enter Serial Number') }}" value="{{ $popup->serial_number }}">
