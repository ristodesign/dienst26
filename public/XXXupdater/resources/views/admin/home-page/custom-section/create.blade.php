        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="pageForm" action="{{ route('admin.home.additional_section.store') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
