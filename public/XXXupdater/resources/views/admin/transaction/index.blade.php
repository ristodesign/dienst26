                        ...
                        <tr>
                          ...
                          <td>
                            @if ($transaction->vendor)
                              <a
                                href="{{ route('admin.vendor_management.vendor_details', ['id' => $transaction->vendor_id, 'language' => $currentLang->code]) }}">{{ @$transaction->vendor->username }}</a>
                            @else
                              {{ '-' }}
                            @endif
                          </td>
                          ...
                          <td>
                            @if (
                                $transaction->transaction_type == 'withdraw' ||
                                    ...
                                    $transaction->transaction_type == 'featured_service_reject' ||
