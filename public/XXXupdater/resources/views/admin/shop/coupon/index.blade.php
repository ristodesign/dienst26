            ...
            <div class="col-lg-12">
              ...
              @else
                @php
                  ...
                  $currency_positon = $currencyInfo->base_currency_text_position;
                @endphp
                    ...
                    <tbody>
                      @foreach ($coupons as $coupon)
                        @php
                          ...
                          $symbol_positon = $currencyInfo->base_currency_symbol_position;
                        @endphp
                        ...
                        <tr>
                          ...
                          <td>
                            @if ($coupon->type == 'fixed')
                              {{ $symbol_positon == 'left' ? $symbol : '' }}{{ $coupon->value }}{{ $symbol_positon == 'right' ? $symbol : '' }}
                            @else
                              {{ $coupon->value . '%' }}
                            @endif
                          </td>
