      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.shop_management.update_charge') }}" method="post">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="in_short_text" name="short_text" rows="2" cols="80" placeholder="{{ __('Enter Short Text') }}"></textarea>
          ...
          <div class="form-group">
            ...
            <input type="number" step="0.01" id="in_shipping_charge" class="form-control ltr" name="shipping_charge" placeholder="{{ __('Enter Shipping Charge') }}">
            <p id="editErr_shipping_charge" class="mt-2 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('Serial Number') . '*' }}</label>
            <input type="number" id="in_serial_number" class="form-control ltr" name="serial_number" placeholder="{{ __('Enter Serial Number') }}">
