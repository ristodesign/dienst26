              ...
              <div class="card border-primary mb-3">
                ...
                <div class="card-body">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item">
                      {{ __('Services') }} <a href="" data-text="{{ __('Services') }}" data-type="services"
                        class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                    </li>
                    ...
                    <li class="list-group-item">
                      {{ __('Products') }} <a href="" data-text="{{ __('Products') }}" data-type="shop"
                        class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                    </li>
                    ...
                    @foreach ($customPages as $customPage)
                      <li class="list-group-item">
                        {{ $customPage->title }} <span
                          class="badge badge-warning ml-1">{{ __('Additional Page') }}</span>
