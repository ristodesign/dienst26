                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input name="address" id="search-address_{{ $currentLang->code }}" class="form-control"
                      ...
                      @if ($websiteInfo->google_map_status == 1)
                        ...
                        <input type="hidden" id="latitude_{{ $currentLang->code }}">
                        <input type="hidden" id="longitude_{{ $currentLang->code }}">
                      @endif
