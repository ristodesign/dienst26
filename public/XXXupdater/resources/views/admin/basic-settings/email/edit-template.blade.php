                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control summernote" name="mail_body" placeholder="{{ __('Enter Mail Body Format') }}"
                        data-height="300">{{ replaceBaseUrl($templateInfo->mail_body, 'summernote') }}</textarea>
