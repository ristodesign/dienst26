...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="{{ route('vendor.service.day', ['staff_id' => $staff->id]) }}">{{ __('Days') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
            data-href="{{ route('vendor.service-hour.bulk_delete') }}">
                        ...
                        <td>
                          <div>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('vendor.service-houre.destroy', $service_hour->id) }}" method="post">
                              @csrf
  ...
  @include('vendors.staff.staff-hour.create')
  @include('vendors.staff.staff-hour.edit')
@endsection
@section('script')
