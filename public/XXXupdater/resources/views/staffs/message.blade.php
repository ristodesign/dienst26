      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-3">
              @include('staffs.partials.languages')
            </div>

            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('staff.service_inquery.message.bulk_delete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('staff.service_inquery.message.destory', ['id' => $message->id]) }}"
                              method="post">
                              @csrf
