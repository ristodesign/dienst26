<div class="main-header">
  ...
  <nav class="navbar navbar-header navbar-expand-lg"
    data-background-color="{{ Session::get('staff_theme_version') == 'light' ? 'white2' : 'dark' }}">
    <div class="container-fluid">
      <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
        ...
        <li>
          <a class="btn btn-primary btn-sm btn-round" target="_blank" href="" title="View Profile">
            <i class="fas fa-eye"></i>
          </a>
        </li>
        <form action="{{ route('staff.change_theme') }}" class="form-inline mr-3" method="POST">
          @csrf
          <div class="form-group">
            <div class="selectgroup selectgroup-secondary selectgroup-pills">
              <label class="selectgroup-item">
                <input type="radio" name="staff_theme_version" value="light" class="selectgroup-input"
                  {{ Session::get('staff_theme_version') == 'light' ? 'checked' : '' }} onchange="this.form.submit()">
                <span class="selectgroup-button selectgroup-button-icon"><i class="fa fa-sun"></i></span>
              </label>

              <label class="selectgroup-item">
                <input type="radio" name="staff_theme_version" value="dark" class="selectgroup-input"
                  {{ !Session::has('staff_theme_version') || Session::get('staff_theme_version') == 'dark' ? 'checked' : '' }}
          ...
          <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
            <div class="avatar-sm">
              @if (Auth::guard('staff')->user()->image != null)
                <img src="{{ asset('assets/img/staff/' . Auth::guard('staff')->user()->image) }}" alt="Vendor Image"
          ...
          <ul class="dropdown-menu dropdown-user animated fadeIn">
            <div class="dropdown-user-scroll scrollbar-outer">
              ...
              <li>
                ...
                <a class="dropdown-item" href="{{ route('staff.edit.profile') }}">
                  {{ __('Edit Profile') }}
                </a>

                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('staff.change_password') }}">
                  {{ __('Change Password') }}
                </a>
