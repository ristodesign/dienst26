...
class ProductController extends Controller
{
    ...
    public function addToCart(Request $request, $id, $quantity): JsonResponse
    {
        ...
        } elseif (! empty($productCart) && ! isset($productCart[$id])) {
    ...
    public function cart(Request $request): View
    {
        ...
        if ($request->session()->has('productCart')) {
            ...
            session()->put('productCart', $arrProduct);
            $queryResult['productCart'] = $productCart;
    ...
    public function removeProduct(Request $request, $id): JsonResponse
    {
        ...
        if (array_key_exists($id, $productList)) {
            ...
            // forget discount price after remove product from cart
    ...
    public function checkAttachment($id): JsonResponse
    {
        try {
            ...
            return response()->json(['errorMsg' => __('Something went wrong!')]);
        }
    }
