...
class PhonePeController extends Controller
{
    ...
    public function index($arrData, $productList)
    {
        ...
        $notify_url = route('shop.purchase_product.phonepe.notify');
        ...
        return $this->initiatePayment($accessToken, $notify_url, route('shop.purchase_product.cancel'), $arrData['grandTotal']);
    }
